...
This repository was used to generate [RHDH dynamic plugin](https://github.com/redhat-developer/rhdh/blob/main/docs/dynamic-plugins/index.md) artifacts for the following plugins:
...
The RHDH dynamic plugin artifacts are now generated by the [rhdh-plugin-export-overlays](https://github.com/redhat-developer/rhdh-plugin-export-overlays) project:
- [Multi-source-security-viewer](https://github.com/orgs/redhat-developer/packages?tab=packages&q=multi-source-security-viewer)
- [ArgoCD](https://github.com/orgs/redhat-developer/packages?tab=packages&q=argocd)
- [Quay](https://github.com/orgs/redhat-developer/packages?tab=packages&q=quay)
- [Tekton](https://github.com/orgs/redhat-developer/packages?tab=packages&q=tekton)
